#!/bin/sh
# Ask an *installed* Tommy Flyleaf what it actually is, on the machine it is on.
# Adapted from slipcase-desktop's; the measurements each check rests on are
# recorded there.
#
...
#
#     ./check-install.sh                    # "/Applications/Tommy Flyleaf.app"
...
app="${1:-/Applications/Tommy Flyleaf.app}"
bundle_id="com.excelano.flyleaf"
team="9K6W5PMFYP"
...
exe="${app}/Contents/MacOS/flyleaf"
...
pid=$(pgrep -f "Tommy Flyleaf.app/Contents/MacOS/flyleaf" | head -1)
