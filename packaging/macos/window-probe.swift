...
// natively on arm64, and the one thing no runner reached was the window, which
// is the code the arm64 walkthrough exists for: `src/opened_document.rs` is
// the only `unsafe` in the application and macOS delivers a double-clicked
// document through an Apple Event rather than argv. Copied from
