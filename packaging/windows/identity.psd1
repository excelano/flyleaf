...
@{
    ...
    #
    #   Get-AppxPackage Excelano.Flyleaf
    #   https://apps.microsoft.com/detail/9PLR61ZP4MX5
    PackageFamilyName = 'Excelano.Flyleaf_nbxmgv0sk86m4'
    StoreId = '9PLR61ZP4MX5'
}
